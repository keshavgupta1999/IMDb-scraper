...
function getMovie(imdbID) {
  ...
  return fetch(`${movieUrl}${imdbID}`)
    ...
    .then(body => {
      ...
      const runTime = $('.subtext time').text();
      ...
      const datePublished = $('a[title="See more release dates"]').text();
      const imdbRating =$('.ratingValue strong').text();
      ...
      const trailer = $('a[data-type="recommends"]').attr('href');
